...
export const USER_PROJECTS_GET_REQUEST = 'USER_PROJECTS_GET_REQUEST';
export const USER_PROJECTS_GET_SUCCESS = 'USER_PROJECTS_GET_SUCCESS';
export const USER_PROJECTS_GET_FAILURE = 'USER_PROJECTS_GET_FAILURE';

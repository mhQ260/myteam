    ...
    return (
        <div className="manage">
            ...
            <div className="manage-container">
                ...
                <Link to="/manage/support" className="navigation-el"><div> [soon]</div></Link>
                ...
                <Link to="/manage/support" className="navigation-el"><div> [soon]</div></Link>
                <Link to="/manage/support" className="navigation-el"><div><i class="fas fa-info"></i> About</div></Link>
            </div>
        </div>
    )
}
